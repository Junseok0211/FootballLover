...
urlpatterns = [
    ...
    path('applied_team/<int:teamMatchingId>', match.views.applied_team, name = "applied_team"),
    path('teamCancel/<int:teamMatchingId>', match.views.teamCancel, name="teamCancel"),
    path('match_approve/<int:teamMatchingId>/<int:team_id>', match.views.match_approve, name = "match_approve"),
    path('match_deny/<int:teamMatchingId>/<int:team_id>', match.views.match_deny, name = "match_deny"),
    ...
    path('teamMatching_editForm/<int:teamMatchingId>', match.views.teamMatching_editForm, name="teamMatching_editForm"),
    path('teamMatching_delete/<int:teamMatchingId>', match.views.teamMatching_delete, name="teamMatching_delete"),
